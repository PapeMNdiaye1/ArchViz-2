    ...
    <Fragment>
      ...
      <div className="Villa_Samb">
        <div className="project_display">
          <h1 className="project_title">Villa Samb</h1>
          <h3 className="project_description">By Archviz | 05 Mai, 2024 |</h3>
          <p>
            Visualisez et concrétisez vos projets d'aménagement grâce à
            l'accompagnement de nos architectes d'intérieur.
          </p>
